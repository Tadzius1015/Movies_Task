        ...
        return (
            <div>
                <Paper className="modalSize">
                    ...
                    <Paper>
                        <p>Are you sure to delete this Movie? This action can't be undone.</p>
                    </Paper>
                    <Paper>
                        <Button onClick={this.props.closeModal} variant="contained" color="primary">Close</Button>
                        <Button style={{marginLeft:'25px'}} onClick={() => this.props.deleteMovie(this.props.id)} variant="contained" color="secondary">Delete</Button>
                    </Paper>
                </Paper>
            </div>
        );
